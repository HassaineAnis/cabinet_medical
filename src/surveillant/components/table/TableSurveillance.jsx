...
const TableSurveillance = () => {
  ...
  return (
    <div className="consultation_table">
      ...
      >
        {currentDoc && (
          <Surveillance data={currentDoc} reference={componentRef} />
        )}
      </div>
      <div className="consultation_table_btn">
        <Link
          to="/surveillant/surveillance/ajouter"
          className="btn_ajout"
          style={{
            textDecoration: "none",
            color: "#fff",
                  ...
                  <tr key={element._id}>
                    ...
                    <td>
                      <div className="action">
                        ...
                        <Link
                          to={`/surveillant/surveillance/modifier/${element._id}`}
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={20}
...
export default TableSurveillance;

  ...
  return (
    <div className="consultation_table">
      ...
      <div
        ...
        className="doc_print"
      >
        {currentDoc && <Baby data={currentDoc} reference={componentRef} />}
      </div>
      <div className="consultation_table_btn">
        <Link
          to="/surveillant/baby/ajouter"
          className="btn_ajout"
          style={{
            textDecoration: "none",
            color: "#fff",
                  ...
                  <tr key={element._id}>
                    ...
                    <td>
                      <div className="action">
                        ...
                        <Link to={`/surveillant/baby/modifier/${element._id}`}>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={20}
                            height={20}
...
export default TableSurveillanceBebe;

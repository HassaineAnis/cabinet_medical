...
const TableEmpolye = () => {
    ...
    return (
        ...
        {isLoading ? (
          ...
          >
            <p> Etes vous sur des vouloir supprimer {`${currentObjet.nom} ${currentObjet.prenom}`} ? </p>
            ...
            <div className="modal_profil" >
              ...
              <div className="modal_profil_info">
                <div className="ligne"><p>Nom : </p> <span>{currentObjet && currentObjet.nom}</span></div>
                 ...
                 <div className="ligne"> <p>Observation :</p> <span>{currentObjet && currentObjet.observation}</span></div>
                 </div>
            </div>

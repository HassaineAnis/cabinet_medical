...
const FormulaireHormo = ({ imprimer, type }) => {
  ...
  useEffect(() => {
    const fetchAnalyse = async () => {
      ...
      try {
        ...
        setFerritine(analyse.document.data.ferritine);
        setHcg(analyse.document.data.hcg);
        setSeuilSensibilite(analyse.document.data.seuilSensibilite);
        setOestradiol(analyse.document.data.oestradiol);
        setProlactine(analyse.document.data.prolactine);
        setCalcuim(analyse.document.data.calcuim);
        setRubeole(analyse.document.data.rubeole);
        setNa(analyse.document.data.na);
        setK(analyse.document.data.k);
        setPsat(analyse.document.data.psat);
        setVitamineD(analyse.document.data.vitamineD);
        setInorgame(analyse.document.data.inograme);
      } catch (e) {

...
const FormulaireBiochimie = ({ imprimer, type }) => {
  ...
  useEffect(() => {
    const fetchAnalyse = async () => {
      ...
      try {
        ...
        setDosage1(analyse.document.data.dosage1);
        setDosage2(analyse.document.data.dosage2);
        setDosage3(analyse.document.data.dosage3);
        setPhosphore(analyse.document.data.phosphore);
        setProteinurie(analyse.document.data.proteinurie);
        setFerSerrique(analyse.document.data.ferSerrique);
        setBilirubineSangD(analyse.document.data.bilirubineSangD);
        setBilirubineSangT(analyse.document.data.bilirubineSangT);
        setBilirubineUrineD(analyse.document.data.bilirubineUrineD);
        setBilirubineUrineT(analyse.document.data.bilirubineUrineT);
        setCoombs(analyse.document.data.coombs);
        setCalcuim(analyse.document.data.calcuim);
        setMagnesium(analyse.document.data.magnesium);
        setRai(analyse.document.data.rai);
        setCrp(analyse.document.data.crp);
        setDiurese(analyse.document.data.diurese);
      } catch (e) {
...
export default FormulaireBiochimie;

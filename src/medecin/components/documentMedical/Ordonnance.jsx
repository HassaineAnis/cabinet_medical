...
<div className='section1'>
    ...
    <div className='section1_info' >
        <div className='info'> 
        <p><strong>Nom :</strong> <span>{patient.nom}</span></p>
        <p><strong>Prénom :</strong> <span>{patient.prenom}</span></p>
        <p><strong>Age :</strong> <span>{patient.age} ans</span></p>
        </div>
    ...
    <p>Etablissement Hospitalier Privé la Colombe Touares II Draa Ben Khedda  <br />
        ...
        Mobile: 0550 96 95 65 - Tél/Fax: 026 43 32 22 / 026 43 33 22 </p>
            ...
            <div className="input_container">
                      ...
                      <textarea  id='traitement'value={inputTraitement} onChange={(e)=>setInput(e.target.value)}></textarea>
            </div>
            ...
            <div className="liste_traitement">
                <ul>
                    ...
                    (<li  key={`${element}-${index}`}>
                        <div>
                        {element}   
                        <svg onClick={(e)=>supprimerTraitement(element,index)} xmlns="http://www.w3.org/2000/svg" height={25} width={25} viewBox="0 0 448 512"> 

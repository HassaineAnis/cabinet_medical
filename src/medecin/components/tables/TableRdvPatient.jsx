    ...
    const [erreur, setErreur] = useState(false);
      ...
      const fetchRdv = async () => {
        ...
        try {
          ...
          const response = await fetch(`http://localhost:3000/api/rendez-vous/patient/${id}`);
        ...
        // console.log(currentObjet.user._id)
         ...
         try {
           ...
           if (reponse.ok) {
             ...
             socket.emit("supprimerRdvPatient",{message:'rendez-vous supprimer'})
           }
         } catch (error) {
...
<Link to={`/medecin/patient/dossier/rendez-vous/ajouter/${id}`}  className='btn_ajout' style={{textDecoration:"none",color:"#fff",display:"flex",justifyContent:"center",alignItems:"center"}}> 
<svg
width={25}
height={25}
fill="none"
...
Ajouter  
        ...
        <Link to={`/medecin/patient/dossier/rendez-vous/archives/${id}`} style={{textDecoration:'none'}} className='btn_archive'> 

...
const MonProfil = ({specialite}) =>{
      ...
      const fetchUsers = async () => {
        ...
        try {
          const response = await fetch(
            `http://localhost:3000/api/medecin/${id}`
          );
   ...
   const [dateNaissance,setDateNaissance] = useState(null)
    ...
    const verifierData = (e) => {
      e.preventDefault();
      if (passwordRef.current.value !== fetchData.user.password) {
    ...
    const modifierProfile = async (e) => {
      ...
      formaData.append("role",fetchData.user.role );
    ...
    const afficherPhoto = ()=>{
      if( fetchData.user && fetchData.user.photo===""){
           return adminPhoto
      
      }else{
        return fetchData.user && fetchData.user.photo
      }
              ...
              <div className="input_section">
                <div className="input_conteneur">
                  ...
                  <input
                    ...
                    defaultValue={fetchData.user && fetchData.user.nom}
                    ref={nomRef}
                ...
                <div className="input_conteneur">
                  ...
                  <input
                    ...
                    defaultValue={fetchData.user && fetchData.user.prenom}
                    id="prenom"
                    ref={prenomRef}
                    pattern="[A-Za-z,-_\s]{3,}"
                ...
                <div className="input_conteneur">
                  ...
                  <input
                    type="text"
                    id="adresse"
                    defaultValue={fetchData.user && fetchData.user.adresse}
                    ref={adresseRef}
                    pattern="[A-Za-z,-_\s]{3,}"
                ...
                <div className="input_conteneur">
                  ...
                  <select
                    name="sexe"
                    id="sexe"
                    defaultValue={fetchData.user && fetchData.user.sexe}
                    ref={sexeRef}
                    required
                  >
                ...
                <div className="input_conteneur">
                  ...
                  <input
                    type="text"
                    defaultValue={fetchData.user && fetchData.user.numeroTel}
                    id="numeroTel"
                    ref={numeroTelRef}
                ...
                <div className="input_conteneur">
                  ...
                  <input
                    type="text"
                    id="numeroSecurite"
                    defaultValue={ fetchData.user && fetchData.user.numeroSecurite}
                    ref={numeroSecurite}
              ...
              (  <option key={`${index}-${element}`} value={element}>{element}</option>)
                ...
                <div className="input_conteneur">
                  ...
                  <input
                    ...
                    id="password"
                    ref={passwordRef}
                    defaultValue={fetchData.user && fetchData.user.password}

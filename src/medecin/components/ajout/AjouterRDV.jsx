...
const AjouterRDV = (props) => {
  ...
  const enregitrer = async (e) => {
    ...
    const data = {
      ...
      typeAccouchement: typeAccouchementRef.current
        ? typeAccouchementRef.current.value
        : "",
      typeCherurgie: typeCherurgieRef.current
        ? typeCherurgieRef.current.value
        : "",
    };

...
const AjouterConsult = () => {
  ...
  formaData.append("documentMedical", element.image,element.titre)
    ...
    try {
      ...
      if (response.ok) {
        ...
        champReset();
        socket.emit("addConsult", { message: "ajout consult" });
      } else {
  ...
  return (
    <div className="Ajouter_consult">
          ...
          <ul className="liste_symptome">
            {symptome.map((element, index) => (
              <li key={`${element}-${index}`}>
                {element}
                <svg
                  onClick={(e) => supprimerSymptome(element, index)}
                  xmlns="http://www.w3.org/2000/svg"
                  height={25}
                  width={25}
                  viewBox="0 0 448 512"
          ...
          <div className="ajouter_document_container">
            ...
            <div className="fichier_externe">
              <div className="fichier_externe_input">
                ...
                <div className="btn_ajout" onClick={ajouterFile}>
                  Ajouter
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height={25}
      ...
      >
        <p> Etes vous sur d'ajouter la consultation?</p>
